...
// --- Brand colors sampled to match your logo ---
const BRAND = {
  teal: "#26B6E0",
  green: "#2DBB7A",
  purple: "#4B3DBB",
...
const HeaderFour = () => {
  ...
  const handleChange = (selectedOption: any) => setSelected(selectedOption);
        ...
        <div className="main-header-two__outer">
            ...
            <div className="menu-wrap" style={{ width: "100%" }}>
              <nav className="menu-nav" style={{ width: "100%" }}>
                <div className="main-header-two__inner" style={{ width: "100%" }}>
                  {/* ====== TOP BAR REMOVED (address + socials) ====== */}
                  ...
                  <div
                    ...
                    style={{
                      ...
                      background:
                        ...
                        `${BRAND.teal} 0%, ${BRAND.green} 40%, ${BRAND.purple} 100%)`,
                    }}
                  >
                          ...
                          >
                            ...
                            <ul className="sub-menu">
                              ...
                              <li>
                                <Link
                                  href="/error"
                                  className={currentPath === "/error" ? "active" : ""}
                                >
                                  404
                                </Link>
                              </li>
                    ...
                    <div className="main-header-two__bottom-right" style={{ gap: 14 }}>
                      ...
                      <Link
                        ...
                        style={{
                          ...
                          background:
                            "linear-gradient(90deg, " +
                            `${BRAND.purple} 0%, ${BRAND.green} 60%, ${BRAND.teal} 100%)`,
                          color: "#fff",
                          fontWeight: 700,
                          whiteSpace: "nowrap",
                        }}
          ...
          <div className={`mobile-menu ${mobileMenu ? "mobile-menu-open" : ""}`}>
            <nav className="menu-box">
              ...
              <div className="menu-outer">
                <ul className="navigation">
                  <li className="active menu-item-has-children">
                    <Link href="#">Home</Link>
                    <ul
                      className={`sub-menu ${home ? "sub-menu-visible test" : "sub-menu-hidden"}`}
                      style={{ zIndex: `${home ? "0" : ""}` }}
                    >
              ...
              {/* Mobile CTA with number (replaces old phone block) */}
              ...
              {/* Social links left as-is; remove if you also want them gone on mobile */}
            </nav>
          </div>
