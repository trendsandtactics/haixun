...
const BRAND = {
  teal: "#26B6E0",   // use this for active color
  green: "#2DBB7A",
  purple: "#4B3DBB",
  dark: "#0E0F2C",
};
        ...
        <div className="main-header-two__outer no-yellow">
          ...
          <div className="logo-inline">
            <Link href="/" aria-label="Home">
              <img src="/img/resource/logo-6.png" alt="Translo / Moltech" />
            </Link>
          </div>
          ...
          <div className="cta-inline">
            ...
            >
              Get a Free Quote: {QUOTE_NUMBER} <span className="icon-right-arrow" style={{ marginLeft: 8 }} />
            </Link>
